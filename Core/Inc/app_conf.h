...
typedef enum
{
  ...
  /* USER CODE BEGIN CFG_Task_Id_With_HCI_Cmd_t */
	CFG_TASK_ExamineBLEBuffer,
	CFG_TASK_ExitBLEDEBUG,
	CFG_TASK_EXTRACTPMCUCMD,
	CFG_TASK_GETCFGFROMPMCU,
	CFG_TASK_MAIN,
	CFG_TASK_PrintPMCUMessageToUSB,
	CFG_TASK_PRINTTOPMCU,
	CFG_TASK_PRINTTOUSB,
	CFG_TASK_RESETPMCU,
	CFG_TASK_SETTINGSMENU,
